...
class Order extends Model implements HasMedia
{
    ...
    protected $fillable = [ 'client_id', 'date', 'pickup_point', 'delivery_point', 'country_id', 'city_id', 'parcel_type', 'total_weight', 'total_distance', 'pickup_datetime', 'delivery_datetime', 'parent_order_id', 'status', 'payment_id', 'payment_collect_from', 'delivery_man_id', 'fixed_charges', 'extra_charges', 'total_amount', 'pickup_confirm_by_client', 'pickup_confirm_by_delivery_man', 'reason', 'weight_charge', 'distance_charge' ];
